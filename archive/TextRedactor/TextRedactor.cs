...
namespace LocalTextRedactor
{
    ...
    internal sealed class MainForm : Form
    {
        ...
        public MainForm()
        {
            Text = "Text Redactor — local & private";
            ...
            heading.Controls.Add(new Label { Text = "Text Redactor", Font = new Font("Segoe UI", 21, FontStyle.Bold), AutoSize = true, Margin = Padding.Empty });
            heading.Controls.Add(new Label { Text = "Runs entirely on this PC. No uploads, telemetry or automatic text storage.", AutoSize = true, ForeColor = Color.FromArgb(82, 99, 116), Margin = Padding.Empty });
            ...
            FormClosed += delegate { debounce.Dispose(); tips.Dispose(); };
    ...
    internal static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            Application.ThreadException += delegate { MessageBox.Show("An unexpected error occurred. Close and reopen Text Redactor. No diagnostic text has been saved."); };
